...
const TelaHome = ({ turno, historico, missoes, onIniciar, onIniciarMissaoDia, onAction, onPausa, onRetomar, onEncerrar, saving, clinicas }) => {
...
export default function App() {
  ...
  const iniciarTurno = useCallback(async (dados) => {
    ...
    // Se tem nova missão, salva ela primeiro
    if (novaMissao) {
    ...
    <>
      ...
      <div className="app-wrap">
        ...
        <div className="screen">
          {tab==="turno"       && <TelaHome turno={turno} historico={historico} missoes={missoes} onIniciar={iniciarTurno} onIniciarMissaoDia={iniciarMissaoDia} onAction={registrarAcao} onPausa={pausarAtendimento} onRetomar={retomarAtendimento} onEncerrar={()=>setShowEncerrar(true)} saving={saving} clinicas={clinicas} />}
